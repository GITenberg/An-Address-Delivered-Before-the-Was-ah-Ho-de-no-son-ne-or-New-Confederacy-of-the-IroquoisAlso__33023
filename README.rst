...
This is a git repository of the source files for the book An Address, Delivered Before the Was-ah Ho-de-no-son-ne or New Confederacy of the IroquoisAlso, Genundewah, a Poem by Schoolcraft, Henry Rowe Hosmer, William H. C. (William Howe Cuyler). This book is in the Public Domain, see the LICENSE file for details.
